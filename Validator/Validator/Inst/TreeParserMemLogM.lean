...
def runPopulatedMem [DecidableEq φ] [Hashable φ] (f: Impl n φ α β) (t: Hedge.Node α) (e: Regex.EnterMem.EnterMap (Symbol n φ)) (l: Regex.LeaveMem.LeaveMap (Symbol n φ)): EStateM.Result String (State n φ α) β :=
